...
public class Huffman {
    ...
    public Huffman(String s)
    {
        ...
        codeTrie = findOptimalCode(H);              // calculate the optimal Data_Structures.Trees_and_compresion.Huffman code as binary trie
    ...
    private static BinaryTrie findOptimalCode(HeapOfBinaryTries  H) {
        ...
        while (H.size() > 1) {
            ...
            BinaryTrie merged = new BinaryTrie(left, right);
